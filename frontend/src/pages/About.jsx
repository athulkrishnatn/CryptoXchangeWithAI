...
const About = () => {
  ...
  return (
    <>
      ...
      <div className="bg-black text-white min-h-screen flex flex-col items-start px-6 md:px-10 relative -top-40">
        
        Hero Section
        <div className="w-full max-w-9xl flex flex-col md:flex-row items-center justify-between md:mt-20">
          {/* Left - Text */}
          <div className="md:w-7xl text-left ms-5 ">
            <h1 className="text-6xl  text-gray-400 font-light leading-[1.4]">
              Stay ahead in crypto with{" "}
              <br />
              
              <span className="text-white -ms-2 font-light">
          ...
          <div className="flex justify-center mt-5 md:mt-0 me-8">
            <video
              ...
              muted
              playsInline
              className="w-[800px] h-[800px]  rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300"
            />
          </div>
        </div>
        ...
        <section className="mt-2 mb-10 w-full max-w-7xl text-left ms-6">
          <h2 className="text-5xl font-light text-white mb-6">About CryptoTrackrAI</h2>
