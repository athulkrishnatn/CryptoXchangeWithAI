  ...
  return (
    <Spotlight  className="mt-[-50px] ml-[-50px]">
      <div className="text-center mt-[27rem] w-full h-screen">
        {/* Heading section */}
        <h1 className="text-6xl bg-gradient-to-r from-gray-500 via-white to-gray-500 bg-clip-text text-transparent font-light leading-snug opacity-90">
        ...
        <h5 className="mt-2 text-lg font-extralight text-gray-400">
